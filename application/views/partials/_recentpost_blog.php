...
<div id="gridlove_posts_widget-2" class="widget gridlove-box gridlove_posts_widget"><h4 class="widget-title">Recent posts<span class="gridlove-slider-controls" data-autoplay="0"></span></h4>

<div class="gridlove-posts-widget gridlove-widget-slider">


<div class="gridlove-posts-widget-item-wrapper">
<?php  foreach($latestblog as $item):?> 
...
<div class="gridlove-posts-widget-item-wrapper">
<?php  foreach($latestblognav2 as $item):?> 
<article class="post-1 post type-post status-publish format-standard has-post-thumbnail hentry category-lifestyle">
