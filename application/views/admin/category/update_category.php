        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label">Icon Place
                       
                    </label>
                    <input type="text" class="form-control" name="iconcat" placeholder="Icon placeholder"
                           value="<?php echo html_escape($category->iconcat); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
