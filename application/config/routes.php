...
$route['socialmessage'] = 'home_controller/socialmessage';
...
$route['subscribe'] = 'home_controller/subscribe';
$route['savesubscribe'] = 'home_controller/savesubscribe';
$route['subscribealready'] = 'home_controller/subscribeAlready';

$route['edition'] = 'home_controller/edition';
$route['editionpdf'] = 'home_controller/editionpdf';
/*
 *
 * ADMIN ROUTES
 *
...
foreach ($languages as $language) {
	if ($language->status == 1 && $general_settings->site_lang != $language->id) {
		...
		$route[$key] = "home_controller/home";
